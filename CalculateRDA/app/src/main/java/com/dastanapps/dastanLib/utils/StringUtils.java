...
public class StringUtils {
    ...
    public static boolean stringLengthShouldbeLessthanOrEqualto(String string, int len) {
        //returns true if valid
        if ((!TextUtils.isEmpty(string)) && string.length() <= len) {
            return true;
        } else
    ...
    public static boolean rangeCheckLessthanOrEqualto(float number, int len) {
        //returns true if valid
    ...
    public static boolean isFormValidLengthCheck(EditText editText, TextInputLayout textInputLayout, String stringName, int length) {
        String noBlank = editText.getText().toString();
        noBlank = noBlank.replace(" ", "");

        if (TextUtils.isEmpty(noBlank)) {
            textInputLayout.setError("Please Enter " + stringName);
        } else if (!stringLengthShouldbeLessthanOrEqualto(noBlank, length)) {
            textInputLayout.setError("Input text should be less than " + length + " character");
        } else {
            textInputLayout.setError(null);
            return true;
        }
    ...
    public static boolean isFormValidRangeCheck(EditText editText, TextInputLayout textInputLayout, String stringName, int length) {
        String noBlank = editText.getText().toString();
        noBlank = noBlank.replace(" ", "");

        if (TextUtils.isEmpty(noBlank)) {
            textInputLayout.setError("Please Enter " + stringName);
        } else if (!rangeCheckLessthanOrEqualto(Float.parseFloat(noBlank), length)) {
            textInputLayout.setError("Input text should be less than " + length );
        } else {
            textInputLayout.setError(null);
            return true;
        }
